  ...
  return (
    <nav
      ...
      style={{
        ...
        width: "100%",
        background:
          "linear-gradient(45deg, rgba(0, 160, 206, 0.8), rgba(220, 82, 241, 0.5))",
      }}
    >
      <div
        className="logo"
      ...
      >
        ...
        >
          URL <Text component="span">Shortener</Text>
        </Text>
      </div>
      <div
        style={{
        ...
        {isLoggedIn ? (
          <Menu shadow="md" width={200} position="bottom-end">
            ...
            <Menu.Dropdown>
              ...
              <Menu.Item onClick={() => navigate("/url/list")}>
                {" "}
                {/* Use the logging handler here */}
                My Urls
              </Menu.Item>
